...
const customStyle = computed(() => ({
    '--toggle-size': props.size,
}));
</script>

<template>
    <div class="sky-toggle-wrapper" :style="customStyle">
        <label class="theme-switch" :title="isDark ? 'Switch to Light Mode' : 'Switch to Dark Mode'">
            <input
                type="checkbox"
